...
/*
  ...
  Résultat attendu : "Hi"
*/
console.log(returnElt(['Hello', 'Good morning', 'Hey', 'Hi'], 3));

/*
  Test 2:
  Résultat attendu : 1
*/
console.log(returnElt([1, 2, 3, 4], 0));

/*
  Test 3:
  Résultat attendu : "bananas"
*/
console.log(returnElt(['Mushrooms', 'bananas'], 1));

/*
  Test 4:
  Résultat attendu : 51
*/
console.log(returnElt([12, 34, 76, 43, 80, 51, 56, 41, 42], 5));
